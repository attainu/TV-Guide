  ...
  return (
    <Router>
      ...
      <Switch>
        ...
        <Route exact path="/search/:keywords/:pageno" component={SearchPage} />
        ...
        <Route exact path="/popular/:pageno" component={PopularPage} />
        <Route exact path="/latest" component={LatestPage} />
        <Route exact path="/latest/:pageno" component={LatestPage} />
      </Switch>
      <Footer />
    </Router>
  );
